function doGet(e) {
  ...
  function checkLogin(username, password) {
    var url = 'https://docs.google.com/spreadsheets/d/1UysjsxBWCgGklo61XqVPkswFf--jwKJpnQmcEdfx1cM/edit#gid=0';
    var ss= SpreadsheetApp.openByUrl(url);
    var webAppSheet = ss.getSheetByName("DATA");
    var getLastRow =  webAppSheet.getLastRow();
    var found_record = 'https://docs.google.com/spreadsheets/d/1UysjsxBWCgGklo61XqVPkswFf--jwKJpnQmcEdfx1cM/edit#gid=0';
 ...
 open('D:\pravallika\Desktop\SCRIPT\add.html') 